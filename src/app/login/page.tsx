...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-1 flex-col justify-center items-center py-12 sm:px-6 lg:px-8 bg-white">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-[480px] max-w-sm">
