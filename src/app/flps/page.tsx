  ...
  return (
    <div className="flex flex-col gap-4 w-full items-center text-white min-h-screen mt-30">
      <div className="max-w-7xl w-full">
        <h2 className="text-4xl font-bold text-white sm:text-5xl w-full px-4 py-4 text-left">
          Tutorials with FLPs
        </h2>
        <Link href="https://www.youtube.com/@Soundschool18" target="_blank">
          <h3 className="text-gray-300 text-lg hover:text-white transition-all duration-300 px-4 py-4 text-left">
