...
const navigation = {
  products: [{ name: "Our Products", href: "/#products" }],
  ...
  social: [
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/the_sound_school_/",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Discord",
      href: "https://discord.gg/VmHFS6bNfp", // TODO: Update to valid link
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: "TikTok",
      href: "https://www.tiktok.com/@the_sound_school_",
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  return (
    <footer className="bg-black">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 pt-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm/6 text-balance text-gray-400">
              Professional MIDI files and music production resources for
        ...
        <div className="mt-16 border-t border-white/10 p-8">
